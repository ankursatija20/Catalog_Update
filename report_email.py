...
if __name__ == "__main__":
    user = os.getenv('USER')
    description_directory = '/home/{}/Catalog_Update/supplier_data/descriptions/'.format(user)  # The directory which contains all the files with data in it.
    ...
    msg = generate_email("jack******@gmail.com", "doll****@gmail.com",
